...
class bam_file():
	...
	def run_SURVIVOR(
		self,SURVIVOR_path, variant_list, max_dist, min_support, type, strand, estimate_distance, min_SV, workdir, output_prefix):
		"""
		Generates list of paths to vcf files generated by SV callers
...
max_dist, min_support, type, strand, estimate_distance, min_support, workdir + '/' + output_prefix + ".SURVIVOR.SV.vcf")
		subprocess.call(command_line, shell=True)
		return workdir + '/' +  output_prefix + ".SURVIVOR.SV.vcf"
